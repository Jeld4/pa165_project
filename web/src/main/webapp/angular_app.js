...
pneuApp.config(['$routeProvider',
    function ($routeProvider) {
        $routeProvider.
        when('/tireDetail', {templateUrl: 'partials/tireDetail.html', controller: 'TireDetailCtrl'}).
        ...
        when('/admin/products', {templateUrl: './partials/tire_detail.html', controller: 'TireDetailCtrl'}).
        ...
        //}).
        otherwise({redirectTo: '/tireDetail'});
    }]);
 ...
 */
eshopControllers.controller('STireDetail', function ($scope, $http) {
    console.log('calling  /eshop/api/v1/tires/');
    $http.get('/eshop/api/v1/tires/' + "0").then(function (response) {
        var tire = response.data['_embedded']['tireDTOt'];
...
eshopControllers.controller('TireDetailCtrl',
    function ($scope, $rootScope, $routeParams, $http) {
        ...
        var productId =  "0" // $routeParams.productId;
        $http.get('/eshop/api/v1/tires/' + productId).then(
            function (response) {
